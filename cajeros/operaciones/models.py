...
class Operacion(models.Model):
    ...
    gaveta_2 = models.ForeignKey(Gaveta, on_delete=models.CASCADE, related_name="gaveta_2", null=True, blank=True)
    ...
    gaveta_3 = models.ForeignKey(Gaveta, on_delete=models.CASCADE, related_name="gaveta_3", null=True, blank=True)
    ...
    gaveta_4 = models.ForeignKey(Gaveta, on_delete=models.CASCADE, related_name="gaveta_4", null=True, blank=True)
